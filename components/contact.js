...
const handleSubmit = DynamicComponentWithNoSSR
const ContactForm = () => {
    return (
        <section className="text-gray-400 bg-gray-900 body-font relative">
        <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
          <div className="lg:w-2/3 md:w-1/2 bg-gray-900 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
            <iframe width="100%" height="100%" title="map" className="absolute inset-0" frameBorder={0} marginHeight={0} marginWidth={0} scrolling="no" src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=Jalpaiguri+West%20Bengal&ie=UTF8&t=&z=14&iwloc=B&output=embed" style={{filter: 'grayscale(1) contrast(1.2) opacity(0.16)'}} />
            <div className="bg-gray-900 relative flex flex-wrap py-6 rounded shadow-md">
              <div className="lg:w-1/2 px-6">
                <h2 className="title-font font-semibold text-white tracking-widest text-xs">ADDRESS</h2>
                <p className="mt-1">Senpara, Jalpaiguri, West Bengali, PIN - 735101</p>
              </div>
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                <h2 className="title-font font-semibold text-white tracking-widest text-xs">EMAIL</h2>
                <a className="text-indigo-400 leading-relaxed" href="mailto:support@opensource.infinityfreeapp.com" target="_blank">support@opensource.infinityfreeapp.com</a>
                <h2 className="title-font font-semibold text-white tracking-widest text-xs mt-4">PHONE</h2>
                <p className="leading-relaxed">+919883105019</p>
              </div>
            </div>
          </div>
          <div className="lg:w-1/3 md:w-1/2 flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            <h2 className="text-white text-lg mb-1 font-medium title-font">Feedback</h2>
            <form action="https://formspree.io/f/xnqlbqwp" method="POST" id="contact-form" onSubmit={handleSubmit}>
            ...
            <p className="text-xs text-gray-400 text-opacity-90 mt-3">Only 2 Feebacks can be taken.(More then 2 will be rejected)</p>
            <p className="text-xs text-gray-400 text-opacity-90 mt-3" id="status"></p>
